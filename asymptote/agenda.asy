...
// Last Change: 2013-11-12 06:40:04 CST
...
agenda[] agendas; include "agendas.asy";
...
times.push("18:30-19:10");
times.push("19:20-20:00");
times.push("20:10-20:50");
times.push("21:00-21:40");
times.push("21:45-22:25");
...
pair posGri  = (slidex*2.4/4, slidey*1.0/4);
real dw = 1.5cm;
real dh = 1.5cm;
...
real heiTex = 1.4cm;
real widLab = 1cm;
pair staPos = (slidex*2.1/4, slidey*3.4/4);
...
draw(shift(posGri)*((5dw,-dm)--(5dw,nd*dh)), Pen);
draw(shift(posGri)*((9dw,-dm)--(9dw,nd*dh)), Pen);

// clock <<<1

real radi = 7cm;
pair posClo = (slidex*0.3/4, slidey*0.8/4) + radi*NE;
...
pair pmid = (slidex*2.0/4, slidey*0.1/4);
...
pair posPass = (posClo.x, slidey*3.2/4);
