...
# Last Change: 2013-11-28 21:52:08 CST
...
# read infos from outlines.txt <<<1
...
# link source code in bookmarks <<<1
...
# change output filename, substitute citation marks <<<1
