...
pair posCir = (slidex*1/8, slidey*2.2/3);
...
pair posCur = (slidex*1.2/3, slidey * 1.6/3);
...
arrow(picPro, "$proportion=\frac{1}{5}$", E, SE, 
    arrow=Arrow(6)); 
label(picPro, "\citep[P.30]{Zhang2010asy}", (A+B)/2, 10S);

pair posPro = (slidex*3/4, slidey * 1.8/3);
...
label(picExp, "\citep[P.36]{Zhang2010asy}", (0, 0), 5SE);

pair posExp = (slidex*0.4/4, slidey * 1.0/3);
...
label(picImp, "\citep[P.37]{Zhang2010asy}", (0, -2), W);

pair posImp = (slidex*1.8/4, slidey * 1.0/3);
...
label(picCli, "\citep[P.40]{Zhang2010asy}", (0, -1), S);

pair posCli = (slidex*3.2/4, slidey * 0.8/3);
