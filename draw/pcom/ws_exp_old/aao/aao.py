...
#     Created: 2014-11-07 09:15:18 BJT
# Last Change: 2014-11-07 10:31:27 BJT
...
#=========================
job            = Job('cal_an_wind')
job.data       = 'aao_an_wind_eof.nc'
job.calcscript = 'cal_an_wind.jnl'
jobs.append(job)

# add AO anomaly wind
#=====================
job            = Job('add_an_wind')
job.calcscript = 'add_an_wind.ncl'
jobs.append(job)
