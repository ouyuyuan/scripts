...
# Description: Analyze log file to extract jobs
#
#       Usage: ./xxx.pl
#      Output: daily-log-yesno.dat, daily-log-jobs.dat
#
#      Author: OU Yuyuan <ouyuyuan@gmail.com>
#     Created: 2012-10-06 19:51:14 CST
# Last Change: 2013-01-17 21:48:05 CST
...
my $outyen  = "$dat_dir/daily-log-yesno.dat";
my $outjob  = "$dat_dir/daily-log-jobs.dat";
