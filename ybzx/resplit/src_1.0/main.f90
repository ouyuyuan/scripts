...
! Description: resplit a set of restart files
!
!      Author: OU Yuyuan <ouyuyuan@lasg.iap.ac.cn>
!     Created: 2015-02-22 13:51:55 BJT
! Last Change: 2015-09-13 07:33:10 BJT
...
!BOC
  ...
  character (len = 80):: old_dir, new_dir
  integer :: new_nx, new_ny, istat, i, old_ncpu

!read in namelist---------------------------------------{{{1
  namelist /param/ old_dir, new_dir, old_ncpu, new_ncpu, rst_prefix
...
!BOP
!
! !IROUTINE: split_latlon
!
! !DESCRIPTION: \input{sections/code-main-split_latlon}
!
! !INTERFACE:
!
...
!BOP
!
! !IROUTINE: resplit_double3d
!
! !DESCRIPTION: \input{sections/code-main-resplit_double3d}
!
! !INTERFACE:
!
...
!BOP
!
! !IROUTINE: resplit_double2d_ice
!
! !DESCRIPTION: 
! 对海冰的2维double型变量进行再分割。
!
! !INTERFACE:
!
...
! !IROUTINE: pre_check
!
! !DESCRIPTION: \input{sections/code-main-pre_check}
!
! !INTERFACE:
!
